...
/**
 * `[description]` renders explanatory text under a group's header, and keeps an empty group
 * visible so that text stands in for the missing rows. An undescribed empty group still
 * auto-hides, as "Cards" does here.
 */
